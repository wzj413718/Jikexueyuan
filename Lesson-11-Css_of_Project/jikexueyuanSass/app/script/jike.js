$(document).ready(function() {
    ...
    $(".search-form ").focus(function() {
        ...
        $(".search-button").css('background', '#35b558 url(../../images/topsearch-icon-white.png) center center no-repeat');

    });
    $(".search-form input").focusout(function() {
        $(".hot-word").css('display', 'block');
        $(".search-button").css('background', 'url(../../images/topsearch-icon.png) center center no-repeat');
    });
